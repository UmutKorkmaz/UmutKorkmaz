...
React/Next.js, React Native, .NET, Node.js, Python/FastAPI, and cloud
infrastructure. I combine hands-on engineering with technical leadership:
modernizing legacy systems, designing scalable APIs, mentoring engineers,
coordinating delivery across teams, and turning ambiguous business problems into
software that ships.
...
| Marketplace and AI features | Built Yazılımcı Bul features for 40,000+ registered members, 500+ developer/agency profiles, AI matching, project analysis, estimates, and CV skill scoring. |
...
| Team leverage | Mentored engineers in React, .NET API development, Git workflows, and modernization practices. |

## Selected Experience

| Role | Scope | Stack |
| --- | --- | --- |
| Lead Software Engineer, Digiturk | Modernizing internal workflow platforms, delivering employee mobile experiences, and architecting AI-powered knowledge workflows with custom SLM training pipelines. | React, React Native, .NET, Oracle, AI/SLM |
| Lead Software Engineer, Pometop | Leading a distributed team building a B2B supply-chain and commerce platform with three trade models, broad category coverage, CI/CD, reviews, and agile delivery. | React, Next.js, TypeScript, Node.js, .NET Core, SQL Server |
| Senior Software Engineer, Yazılımcı Bul | Building Turkey's developer marketplace and AI-assisted project platform, including intelligent matching, project analysis, budget/timeline estimation, escrow, and admin workflows. | React, Node.js, Express, MongoDB |
...
| [re-shell](https://github.com/UmutKorkmaz/re-shell) | Full-stack development platform CLI for distributed microservices and micro-frontends, with production-ready backend templates and generation workflows. | TypeScript, Node.js |
...
| Data and messaging | PostgreSQL, SQL Server, MySQL, MongoDB, Oracle Database, PL/SQL, Redis, RabbitMQ |
| Cloud and infrastructure | Azure, Azure DevOps, AWS, Docker, LXC, Nginx, OpenResty, HAProxy, IIS, Bind9, Knot, GitHub Actions |
...
| Payments | iyzico, PayTR, PayPal, Garanti Sanal POS, Kuveyt Türk Sanal POS |
